pro s_getoTrackByDeformationModel, oObjectModel = oObjectModel, stack_tlb = stack_tlb, oGroupReference = oGroupReference, poCurrROIGraphicModel = poCurrROIGraphicModel
        ...
        for j = 0, numObjetosActual-1 do begin
          if(i eq 0) then begin
            ...
            ; recovery actual volume data
             pPoints = *((C_sROI3DGroupObjActual->get(position = j))->getpWherePoints())
...
; Render section 
   ...
   for j = 0, maximoObjetos-1 do begin 
     ...
     for i = 0, totalTimes-1 do begin
             if(i eq 0) then color(*,0) = [200,200,200]    
