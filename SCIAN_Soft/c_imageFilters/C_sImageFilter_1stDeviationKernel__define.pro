...
;
; CALLING SEQUENCE:
;       result = obj_new('C_sImageFilter_1stDeviationKernel' )
;
; METHOHDS:
...
function C_sImageFilter_1stDeviationKernel::getImageFilterType
    return, 'Single_Image_Filter_Method'
end

function C_sImageFilter_1stDeviationKernel::apply, image = image
...
function C_sImageFilter_1stDeviationKernel::init
...
pro C_sImageFilter_1stDeviationKernel__define
  tmp = {C_sImageFilter_1stDeviationKernel, pParamStruct: ptr_new(), inherits C_sImageFilter}
end