...
; CALLING SEQUENCE:
;       result = obj_new('C_sImageFilter_Threshold' )
;
; METHOHDS:
;_____________________________IOISIOI____________________
; I will propose delete this filter and use... ThresholdBinary or Threshold FUllScale....

function C_sImageFilter_Threshold::getImageFilterType
    return, 'Single_Image_Filter_Method'
end

function C_sImageFilter_Threshold::apply, image = image
...
function C_sImageFilter_Threshold::applySelect, image = image, select = select
...
function C_sImageFilter_Threshold::init
    filterStruct = {Name: 'C_Threshold',$     ;  Filter Name.
...
pro C_sImageFilter_Threshold__define
  tmp = {C_sImageFilter_Threshold, pParamStruct: ptr_new(), inherits C_sImageFilter}
end