...
; NAME:
;      C_sImageFilter_ImageFillNeighboursRangeTCh
;
; PURPOSE:
...
function C_sImageFilter_ImageFillNeighboursRangeTCh::getImageFilterType
   return, 'Multiple_Image_Filter_Method'
end

function C_sImageFilter_ImageFillNeighboursRangeTCh::apply, image = image,$
...
function C_sImageFilter_ImageFillNeighboursRangeTCh::init
   filterStruct = {Name:'C_ImageFillNeighboursRangeTCh',$   ; Filter Name.
...
pro C_sImageFilter_ImageFillNeighboursRangeTCh__define
   tmp = {C_sImageFilter_ImageFillNeighboursRangeTCh, pParamStruct:ptr_new(), inherits C_sImageFilter}
end