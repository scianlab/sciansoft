...
function C_sImageFilter_OpenClose::getImageFilterType
    return, 'Single_Image_Filter_Method'
end

function C_sImageFilter_OpenClose::apply, image = image
...
function C_sImageFilter_OpenClose::init
...
pro C_sImageFilter_OpenClose__define
   tmp = {C_sImageFilter_OpenClose, pParamStruct:ptr_new(), inherits C_sImageFilter}
end