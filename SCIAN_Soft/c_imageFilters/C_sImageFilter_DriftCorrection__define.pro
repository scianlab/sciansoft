...
; CALLING SEQUENCE:
;       result = obj_new('C_sImageFilter_DriftCorrection' )
;
; METHOHDS:
...
function C_sImageFilter_DriftCorrection::getImageFilterType
   return, 'Multiple_Image_Filter_Method'
end


function C_sImageFilter_DriftCorrection::apply, image = image, stack_tlb = stack_tlb,$
...
function C_sImageFilter_DriftCorrection::init
...
pro C_sImageFilter_DriftCorrection__define
   tmp = {C_sImageFilter_DriftCorrection, pParamStruct: ptr_new(), inherits C_sImageFilter}
end
