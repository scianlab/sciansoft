...
;
; CALLING SEQUENCE:
;       result = obj_new('C_sImageFilter_BorderDivCenterPixII' )
;
; METHOHDS:
...
function C_sImageFilter_BorderDivCenterPixII::getImageFilterType
  return, 'Single_Image_Filter_Method'
end


function C_sImageFilter_BorderDivCenterPixII::apply, image = image
...
function C_sImageFilter_BorderDivCenterPixII::init

   filterStruct = {Name: 'C_BorderDivCenterPixII',$  ; Filter Name.
...
pro C_sImageFilter_BorderDivCenterPixII__define
  tmp = {C_sImageFilter_BorderDivCenterPixII, pParamStruct: ptr_new(), inherits C_sImageFilter}
end
