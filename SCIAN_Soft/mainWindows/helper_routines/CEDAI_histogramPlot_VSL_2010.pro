pro CEDAI_histogramPlot_VSL_2010, path = path, vect = vect, name = name, veloLimitsVCL = veloLimitsVCL, veloLimitsVSL = veloLimitsVSL, linesFlag = linesFlag, tempFileName = tempFileName
