pro CEDAI_textRoundCellsPlot, filename, string_0, string_1, string_2, string_3, string_4, string_5, string_6, string_7, string_8, string_9, string_10, string_11,string_21,string_23,nom
...
;        Filename = 'C:\RSI\Mia\M1_1_1seg_sinROIs\Text.tiff'
   ...
   myFont = obj_new('IDLgrFont', 'arial', SIZE = 13)
...
;   boxR[2,*,*] = 255 ; 0
   ...
   oText_0 = obj_new('IDLgrText', location = [-0.8, 17.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_0, font = myfont, /enable_formatting)
   ...
   oText_4 = obj_new('IDLgrText', location = [15.0, 17.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_4, font = myfont, alignment = 1, /enable_formatting)
