pro CEDAI_histogramPlot_VSL, path = path, vect = vect, name = name, veloLimitsVCL = veloLimitsVCL, veloLimitsVSL = veloLimitsVSL, linesFlag = linesFlag, tempFileName = tempFileName
