pro CEDAI_textPlot_Count_Short_Fragm, filename, string_0, string_1, string_2, string_3, string_4, string_5,textUnits,string_441,string_442,string_443,string_444
;DNA Framentation
DEVICE,DECOMPOSED=0
...
;string_443             Susana - texto adicional, promedio tamaño fragmentados
;string_444             Susana - texto adicional, promedio tamaño no fragmentados
      ;Text Base
   ...
   ; MOR - dummy to get range - END
    ...
    if n_elements(string_443) eq 0 then string_441 = ''
    if n_elements(string_444) eq 0 then string_442 = ''
 ...
 ;  oText_0 = obj_new('IDLgrText', location = [0.0, 22.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_0, font = myfontHeader, alignment = 0, /enable_formatting)
   ...
   oText_3 = obj_new('IDLgrText', location = [17.0, 17.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_3, font = myfont, alignment = 1, /enable_formatting)
   oText_4 = obj_new('IDLgrText', location = [17.0, 12.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_4, font = myfont, alignment = 1, /enable_formatting)
...
;   oText_6 = obj_new('IDLgrText', location = [26.0, 12.0], XCoord_Conv=xs1, YCoord_Conv=ys1, textUnits, font = myfont, alignment = 1, /enable_formatting)
   oText_5 = obj_new('IDLgrText', location = [28.0, 17.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_5, font = myfont, alignment = 1, /enable_formatting)
   oText_6 = obj_new('IDLgrText', location = [28.0, 12.0], XCoord_Conv=xs1, YCoord_Conv=ys1, textUnits, font = myfont, alignment = 1, /enable_formatting)
   ...
   oText_443 = obj_new('IDLgrText', location = [15.0, 8.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_443, font = myfont441, alignment = 0, /enable_formatting)
   oText_444 = obj_new('IDLgrText', location = [15.0, 4.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_444, font = myfont441, alignment = 0, /enable_formatting)
  ...
  ; oModel->add, oText_0
   ...
   oModel->add, oText_443
   oModel->add, oText_444
