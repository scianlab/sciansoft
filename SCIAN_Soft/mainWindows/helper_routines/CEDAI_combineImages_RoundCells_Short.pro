pro CEDAI_combineImages_RoundCells_Short, background, imageLeft, textRight, fileName
...
;  y3 = size_text2[2]
 ...
 ; Define Starting Point TestName
  start_right_X4 = 580
  start_right_Y4 = 510; posición Y en informe, pequeñas quedan abajo, 600 sobrepasa la linea del informe, 550 tapa el rotulo "Concentration"
  ...
  image_background[*,start_right_X4:start_right_X4+X2-1,start_right_Y4:start_right_Y4+Y2-1] = image_text        ; motility stats
