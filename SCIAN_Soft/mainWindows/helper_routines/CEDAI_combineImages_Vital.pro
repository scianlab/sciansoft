pro CEDAI_combineImages_Vital, background, imageLeft, fileName, textLeft
...
; susana - incluyo imagen en informe de vitalidad TOTAL - INICIO
  image_right_before = read_image(imageLeft)
  size_left = size(image_left_before)
  imageLeft = congrid(image_left_before, 3,325 ,235)
  imageLeft = image_left[*,15:310,15:195]
  
  size_left = size(image_left, /dim); activate this line for image VitalidadEspermatica_Zoom.png
  x1 = size_left[1] ;trajectory
  y1 = size_left[2] ; trajectory
; susana - incluyo imagen en informe de vitalidad TOTAL - FIN
 ...
 ; y2 = size_text[2]
  ...
  ;start_right_X2 = 580
  start_right_X2 = 600 ; move text to right
  ;start_right_Y2 = 220
  start_right_Y2 = 180
 ...
 ; Define Starting Point TestName
  ...
  ;image_background[*,start_text_X2:start_text_X2+X4-1, start_text_Y2:start_text_Y2+Y4-1] = image_name2      ; experimental label  nombre ultima carpeta
