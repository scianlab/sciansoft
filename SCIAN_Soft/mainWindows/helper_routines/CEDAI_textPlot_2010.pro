pro CEDAI_textPlot_2010, filename, string_0, string_1, string_2, string_3, string_4, string_5, string_6, string_7, string_8, string_9, string_10, string_11,string_21,string_23,nom
...
;   boxY[2,*,*] = 0  
   ...
   ;oImage_1 = obj_new('IDLgrImage',boxY,location = [-0.8, 12.0], XCoord_Conv=xs1, YCoord_Conv=ys1);Comento TypeB
   oImage_2 = obj_new('IDLgrImage',boxG,location = [-0.8, 12.0], XCoord_Conv=xs1, YCoord_Conv=ys1)
   oImage_3 = obj_new('IDLgrImage',boxB,location = [-0.8, 7.0], XCoord_Conv=xs1, YCoord_Conv=ys1)
   ;[-0.8, 2.0]
   ; Susana - Coloco un box temporalmente del color de los NC (No Clasificados para Movilidad) - INICIO
   ...
   ;oText_1 = obj_new('IDLgrText', location = [2.0, 12.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_1, font = myfont, /enable_formatting) ;comento Type B
   oText_2 = obj_new('IDLgrText', location = [2.0, 12.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_2, font = myfont, /enable_formatting)
   oText_3 = obj_new('IDLgrText', location = [2.0, 7.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_3, font = myfont, /enable_formatting)
   ;[2.0, 2.0]
   ...
   ;oText_5 = obj_new('IDLgrText', location = [13.0, 12.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_5, font = myfont, alignment = 1, /enable_formatting) ;comento Type B
   oText_6 = obj_new('IDLgrText', location = [13.0, 12.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_6, font = myfont, alignment = 1, /enable_formatting)
   oText_7 = obj_new('IDLgrText', location = [13.0, 7.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_7, font = myfont, alignment = 1, /enable_formatting)
   ;[13.0, 2.0]
   ...
   ;oText_9 = obj_new('IDLgrText', location = [22.0, 12.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_9, font = myfont, alignment = 1, /enable_formatting);Comento TypeB
   oText_10 = obj_new('IDLgrText', location = [22.0, 12.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_10, font = myfont, alignment = 1, /enable_formatting)
   oText_11 = obj_new('IDLgrText', location = [22.0, 7.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_11, font = myfont, alignment = 1, /enable_formatting)
   ;[22.0, 2.0]
...
;   oText_11 = obj_new('IDLgrText', location = [6.5, 2.5], string_11, font = myfont, alignment = 1, /enable_formatting)
   ...
   oModel->remove, /all
   oModel->add, oText_0
   ;oModel->add, oText_1 ;comento Type B
   oModel->add, oText_2
   oModel->add, oText_3
   oModel->add, oText_4
   ;oModel->add, oText_5 ; Comento TypeB
   oModel->add, oText_6
   oModel->add, oText_7
   oModel->add, oText_8
   ;oModel->add, oText_9;Comento TypeB
   oModel->add, oText_10
   oModel->add, oText_11
   ;NUEVO SUSANA INCLUYO TRACKOBJECTS NO CLASIFICADOS POR POCOS PUNTOS SEGUIDOS
   ;oModel->add, oText_21
   ...
   oModel->Add, oImage_0
   ;oModel->Add, oImage_1 ;comento TypeB
   oModel->Add, oImage_2
   oModel->Add, oImage_3
   ; Susana - Coloco un box temporalmente del color de los NC (No Clasificados para Movilidad) - INICIO
