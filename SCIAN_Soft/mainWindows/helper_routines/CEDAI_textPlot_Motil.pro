...
; MOR - add boxes with associated color for the text - BEGIN
   ...
   ;oImage_0 = obj_new('IDLgrImage',boxR,location = [-0.8, 14.0], XCoord_Conv=xs1, YCoord_Conv=ys1) ;susana mueve a la izquierda
   ...
   oImage_2 = obj_new('IDLgrImage',boxG,location = [-4.0, 2.6], XCoord_Conv=xs1, YCoord_Conv=ys1)
   oImage_3 = obj_new('IDLgrImage',boxB,location = [-4.0, -2.1], XCoord_Conv=xs1, YCoord_Conv=ys1)
