pro CEDAI_textPlotMotil_2010, filename, string_0, string_2, string_3, string_4, string_6, string_7, string_8, string_10, string_11, string_21, string_23, string_27, string_28, string_29, string_30,string_8_1,string_8_2,string_8_3,string_8_4,string_10_1,string_10_2,string_10_3,string_10_4,string_11_1,string_11_2,string_11_3,string_11_4,string_31,string_32
;pro CEDAI_textPlotMotil_2010, filename, string_0, string_1, string_2, string_3, string_4, string_5, string_6, string_7, string_8, string_9, string_10, string_11, string_21, string_23, string_27, string_28, string_29, string_30,string_8_1,string_8_2,string_8_3,string_8_4,string_9_1,string_9_2,string_9_3,string_9_4,string_10_1,string_10_2,string_10_3,string_10_4,string_11_1,string_11_2,string_11_3,string_11_4,string_31,string_32
;Desarrollado para informe especial de Alejandra Garcia, informa motilidad en 3 grupos PR (A+B)  NP (C) y IM (D)
...
; MOR - add boxes with associated color for the text - BEGIN
   ...
   boxB[1, *,*] = 0
   boxB[2,*,*] = 255
   ; green - type C - TYPE NP
   boxG = bytarr(3, 2, 2)
   boxG[0,*,*] = 0
   boxG[1, *,*] = 255
   boxG[2,*,*] = 0
;   ; yellow - type B - TYPE PR
;   boxY = bytarr(3, 2, 2)
;   boxY[0,*,*] = 255
;   boxY[1, *,*] = 255
;   boxY[2,*,*] = 0  
   ...
   ;oImage_1 = obj_new('IDLgrImage',boxY,location = [-4.0, 7.3], XCoord_Conv=xs1, YCoord_Conv=ys1)
   oImage_2 = obj_new('IDLgrImage',boxG,location = [-4.0, 7.3], XCoord_Conv=xs1, YCoord_Conv=ys1)
   oImage_3 = obj_new('IDLgrImage',boxB,location = [-4.0, 2.6], XCoord_Conv=xs1, YCoord_Conv=ys1)
   ;[-4.0, -2.1]
   ...
   oText_2 = obj_new('IDLgrText', location = [-1.8, 7.3], XCoord_Conv=xs1, YCoord_Conv=ys1, string_2, font = myfont, /enable_formatting)
   oText_3 = obj_new('IDLgrText', location = [-1.8, 2.6], XCoord_Conv=xs1, YCoord_Conv=ys1, string_3, font = myfont, /enable_formatting)
   ;[-1.8, -2.1]
   ;SUSANA - Types - FIN
...
;   oText_WOBunits = obj_new('IDLgrText', location = [23.2, 15.5], XCoord_Conv=xs1, YCoord_Conv=ys1, string_32 , font = myFontUnits ,  /enable_formatting)
   ...
   oText_6 = obj_new('IDLgrText', location = [6.0, 7.3], XCoord_Conv=xs1, YCoord_Conv=ys1, string_6, font = myfont, alignment = 1, /enable_formatting)
   oText_7 = obj_new('IDLgrText', location = [6.0, 2.6], XCoord_Conv=xs1, YCoord_Conv=ys1, string_7, font = myfont, alignment = 1, /enable_formatting)
   ;[6.0, -2.1]
   ...
   oText_6_2 = obj_new('IDLgrText', location = [10.0, 7.3], XCoord_Conv=xs1, YCoord_Conv=ys1, string_10_3, font = myfont, alignment = 1, /enable_formatting)
   oText_7_2 = obj_new('IDLgrText', location = [10.0, 2.6], XCoord_Conv=xs1, YCoord_Conv=ys1, string_11_3, font = myfont, alignment = 1, /enable_formatting)
   ;[10.0, -2.1]
   ...
   oText_6_3 = obj_new('IDLgrText', location = [14., 7.3], XCoord_Conv=xs1, YCoord_Conv=ys1, string_10_4, font = myfont, alignment = 1, /enable_formatting)
   oText_7_3 = obj_new('IDLgrText', location = [14.0, 2.6], XCoord_Conv=xs1, YCoord_Conv=ys1, string_11_4, font = myfont, alignment = 1, /enable_formatting)
   ;[14.0, -2.1]
   ...
   oText_6_4 = obj_new('IDLgrText', location = [18.0, 7.3], XCoord_Conv=xs1, YCoord_Conv=ys1, string_10, font = myfont, alignment = 1, /enable_formatting)
   oText_7_4 = obj_new('IDLgrText', location = [18.0, 2.6], XCoord_Conv=xs1, YCoord_Conv=ys1, string_11, font = myfont, alignment = 1, /enable_formatting)
   ;[18.0, -2.1]
   ...
   oText_6_5 = obj_new('IDLgrText', location = [22.0, 7.3], XCoord_Conv=xs1, YCoord_Conv=ys1, string_10_1, font = myfont, alignment = 1, /enable_formatting)
   oText_7_5 = obj_new('IDLgrText', location = [22.0, 2.6], XCoord_Conv=xs1, YCoord_Conv=ys1, string_11_1, font = myfont, alignment = 1, /enable_formatting)
   ;[22.0, -2.1]
   ...
   oText_6_6 = obj_new('IDLgrText', location = [26.0, 7.3], XCoord_Conv=xs1, YCoord_Conv=ys1, string_10_2, font = myfont, alignment = 1, /enable_formatting)
   oText_7_6 = obj_new('IDLgrText', location = [26.0, 2.6], XCoord_Conv=xs1, YCoord_Conv=ys1, string_11_2, font = myfont, alignment = 1, /enable_formatting)
   ;[26.0, -2.1]
