pro CEDAI_textPlotOMS, filename, string_0, string_1, string_2, string_3, string_4, string_5, string_6, string_7, string_8, string_9, string_10, string_11,string_21,string_23,nom
...
;        Filename = 'C:\RSI\Mia\M1_1_1seg_sinROIs\Text.tiff'
      ...
      ;Text Base
   ;oBuffer = obj_new('IDLgrBuffer', dimensions = [340, 130]) ;default
   oBuffer = obj_new('IDLgrBuffer', dimensions = [340, 130]) 
   myFont = obj_new('IDLgrFont', 'arial', SIZE = 15)
   myfontBIG = obj_new('IDLgrFont', 'arial', SIZE = 18)
   ;myFontConcentration = obj_new('IDLgrFont', 'arial', SIZE = 13)
...
;   boxY[2,*,*] = 0  
   ...
   oImage_0 = obj_new('IDLgrImage',boxR,location = [-0.8, 19.0], XCoord_Conv=xs1, YCoord_Conv=ys1) ;susana mueve a la izquierda
   oImage_1 = obj_new('IDLgrImage',boxG,location = [-0.8, 14.0], XCoord_Conv=xs1, YCoord_Conv=ys1); ex boxY, yellow
   oImage_2 = obj_new('IDLgrImage',boxB,location = [-0.8, 9.0], XCoord_Conv=xs1, YCoord_Conv=ys1); ex boxG
   ...
   ;oText_A = obj_new('IDLgrText', location = [2.0, 20.0], XCoord_Conv=xs1, YCoord_Conv=ys1, 'MOTILITY : ', font = myfontBIG, /enable_formatting)
   ...
   oText_0 = obj_new('IDLgrText', location = [2.0, 19.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_0, font = myfont, /enable_formatting)
   
   ;oText_1 = obj_new('IDLgrText', location = [2.0, 12.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_1, font = myfont, /enable_formatting)
   oText_1 = obj_new('IDLgrText', location = [2.0, 14.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_1, font = myfont, /enable_formatting)
   
   ;oText_2 = obj_new('IDLgrText', location = [2.0, 7.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_2, font = myfont, /enable_formatting)
   oText_2 = obj_new('IDLgrText', location = [2.0, 9.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_2, font = myfont, /enable_formatting)
   
   ;;oText_3 = obj_new('IDLgrText', location = [-0.5, 2.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_3, font = myFontConcentration, /enable_formatting); concentration hacia la izquierda
   ;oText_3 = obj_new('IDLgrText', location = [-0.5, 2.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_3, font = myfont, /enable_formatting); concentration hacia la izquierda
   ;oText_B = obj_new('IDLgrText', location = [2.0, 2.0], XCoord_Conv=xs1, YCoord_Conv=ys1, 'Concentration : ', font = myfontBIG, /enable_formatting)
   
   oText_4 = obj_new('IDLgrText', location = [13.0, 19.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_4, font = myfont, alignment = 1, /enable_formatting)
   oText_5 = obj_new('IDLgrText', location = [13.0, 14.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_5, font = myfont, alignment = 1, /enable_formatting)
   oText_6 = obj_new('IDLgrText', location = [13.0, 9.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_6, font = myfont, alignment = 1, /enable_formatting)
   ;;oText_7 = obj_new('IDLgrText', location = [13.0, 2.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_7, font = myfont, alignment = 1, /enable_formatting); concentration hacia la izquierda
   ;oText_7 = obj_new('IDLgrText', location = [11.3, 2.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_7, font = myfont, alignment = 1, /enable_formatting); concentration hacia la izquierda
   ...
   oText_8 = obj_new('IDLgrText', location = [22.0, 19.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_8, font = myfont, alignment = 1, /enable_formatting)
   oText_9 = obj_new('IDLgrText', location = [22.0, 14.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_9, font = myfont, alignment = 1, /enable_formatting)
   oText_10 = obj_new('IDLgrText', location = [22.0, 9.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_10, font = myfont, alignment = 1, /enable_formatting)
   ;;oText_11 = obj_new('IDLgrText', location = [22.0, 2.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_11, font = myfont, alignment = 1, /enable_formatting); concentration hacia la izquierda
   ;oText_11 = obj_new('IDLgrText', location = [16.0, 2.0], XCoord_Conv=xs1, YCoord_Conv=ys1, string_11, font = myfont, alignment = 1, /enable_formatting); concentration hacia la izquierda
