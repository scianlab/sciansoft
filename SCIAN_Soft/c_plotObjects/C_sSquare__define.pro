...
pro C_sSquare::SetProperty,x1=x1, y1=y1, x2=x2, y2=y2,  color = color
...
pro C_sSquare::GetProperty, x1=x1, y1=y1, x2=x2, y2=y2,  color = color
    x1= self.x1
    x2= self.x2
    y1= self.y1
    y2= self.y2
...
function C_sSquare::init, x1=x1, y1=y1, x2=x2, y2=y2,  color = color
...
pro C_sSquare__define
   tmp = { C_sSquare, x1:0, y1:0, x2:0, y2:0, color:0}
end
