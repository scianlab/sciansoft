; $Id: s_CIR_3PNT.pro,v 1.13 2004/01/21 15:54:49 scottm Exp $
;
; Copyright (c) 1992-2004, Research Systems, Inc.  All rights reserved.
;   Unauthorized reproduction prohibited.
;

PRO s_cir_3pnt, xIn, yIn, r, x0, y0, xyRes = xyRes
...
;-
   ...
   if (n_elements(xyRes) eq 0) then begin
        x = double(xIn)
        y = double(yIn)
   endif else begin
        x = double(xIn * xyRes[0])
        y = double(yIn * xyRes[1])
   endelse
