...
;
; CALLING SEQUENCE:
;       result = obj_new('C_sROIParam_3DObjNumber' )
;
; METHOHDS:
;_____________________________IOISIOI____________________

pro C_sROIParam_3DObjNumber::apply, C_sROI3DGroupObj = C_sROI3DGroupObj,  position = position

    whParam = [(where( *(*self.pParamStruct).pNames eq '3D Object Number [N]'))[0] ]
...
function C_sROIParam_3DObjNumber::init

    ROIParamStruct = {name:'3D Object Number',$     ;  ROI Name.
    ...
    ROIParamNames = ['3D Object Number [N]']
    ROIParamActive = [1]
    ROIParamMin = [0]
    ROIParamMax = [0]
    ROIParamValues = [0]
    ...
    ROIValueStruct = {name:'3D Object Number',$
                      type:'3D ROI-Parameter-Method',$
...
pro C_sROIParam_3DObjNumber__define
   tmp = {C_sROIParam_3DObjNumber, pParamStruct:ptr_new(),pValueStruct:ptr_new(),inherits C_sROIParam}
end