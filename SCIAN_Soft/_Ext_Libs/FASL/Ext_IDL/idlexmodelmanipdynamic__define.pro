; inherits $Id: //depot/idl/IDL_70/idldir/lib/utilities/idlexmodelmanip__define.pro#1 $
;
; NAME:
;       idlexmodelmanipdynamic
;
; PURPOSE:
...
; CALLING SEQUENCE:
;
;       oMm = OBJ_NEW('idlexmodelmanipdynamic')
;
;   idlexmodelmanipdynamic::MouseTrack, pos, oDest
;   idlexmodelmanipdynamic::MouseUp, pos, oDest
;   idlexmodelmanipdynamic::MouseDown, [event.x, event.y], oDest
;   idlexmodelmanipdynamic::SetTarget, oTarget, oDest, _extra=e
;   idlexmodelmanipdynamic::Undo -- undo manipulation
;   idlexmodelmanipdynamic::SetProperty
;   idlexmodelmanipdynamic::GetProperty
...
;
; KEYWORD PARAMETERS:
;       idlexmodelmanipdynamic::Init:
;
;
; MODIFICATION HISTORY:
;       Written by:     RJF, Nov 1996
;       Modified by:    FASL, Sept 2012 from  idlexmodelmanip
;-

;----------------------------------------------------------------------------
;Create a polyline object representing the manipulation tool
;
PRO idlexmodelmanipdynamic::Build_Manip_Visual
    compile_opt hidden
...
;Destroy the object
;
PRO idlexmodelmanipdynamic::Cleanup
    compile_opt hidden
;
...
;
PRO idlexmodelmanipdynamic::SetProperty, $
    TRANSLATE=translate, $
...
;
PRO idlexmodelmanipdynamic::GetProperty, $
    TARGET=target, $
    MODE=mode, $
    TWO_D=two_d, $
    MANIP_SHOW_SEL=manip_show_sel, $
...
;
PRO idlexmodelmanipdynamic::Undo
    compile_opt hidden
...
;
PRO idlexmodelmanipdynamic::SetTarget, oTarget, oDest, _EXTRA=e
    compile_opt hidden

    FORWARD_FUNCTION idlexmodelmanipdynamic__get_bounds
    ON_ERROR, 2 ; Return to caller on error.
...
;
    box = idlexmodelmanipdynamic__get_bounds(oTarget, oTarget)
...
;
FUNCTION idlexmodelmanipdynamic::Get_View
    compile_opt hidden
    tobj = self
...
;
PRO idlexmodelmanipdynamic::MouseDown, pos, dest
    compile_opt hidden
...
;
PRO idlexmodelmanipdynamic::MouseUp, pos, dest
    ...
    CASE self.mode OF
        ...
        1: BEGIN ;Rotation. - compute the final rotation
                ...
                mult = idlexmodelmanipdynamic__Quaternion_m3(q)
                tm = mult # tm
           END
        2: BEGIN ;Scale.
...
;
PRO idlexmodelmanipdynamic::MouseTrack, pos, dest
...
;
FUNCTION idlexmodelmanipdynamic::V_to_Data,dest,v
    compile_opt hidden
...
;
PRO idlexmodelmanipdynamic__define
    compile_opt hidden
    struct_hide = { idlexmodelmanipdynamic,  $
        INHERITS idlexmodelmanip, $
        centerRot: [0.0d,0.0d,0.0d] $
        }
END
;----------------------------------------------------------------------------
