...
function NC_C_sImageFilter_FillNeighbours::getImageFilterType
   return, 'Multiple_Image_Filter_Method'
end

function NC_C_sImageFilter_FillNeighbours::getImageFilterDevelopmentalState
...
function NC_C_sImageFilter_FillNeighbours::apply, image = image,$
...
function NC_C_sImageFilter_FillNeighbours::init
...
pro NC_C_sImageFilter_FillNeighbours__define
   tmp = {NC_C_sImageFilter_FillNeighbours, pParamStruct:ptr_new(), inherits C_sImageFilter}
end