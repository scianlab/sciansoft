...
;     Jan Scheer
; CALLING SEQUENCE:
;       result = obj_new('NC_C_sImageFilter_ThresholdOtsu' )
;
; METHOHDS:
...
function NC_C_sImageFilter_ThresholdOtsu::getImageFilterType
    return, 'Single_Image_Filter_Method'
end

function NC_C_sImageFilter_ThresholdOtsu::getImageFilterDevelopmentalState
...
function NC_C_sImageFilter_ThresholdOtsu::apply, image = image
...
function NC_C_sImageFilter_ThresholdOtsu::init
...
pro NC_C_sImageFilter_ThresholdOtsu__define
  tmp = {NC_C_sImageFilter_ThresholdOtsu, pParamStruct: ptr_new(), inherits C_sImageFilter}
end
