...
;
; CALLING SEQUENCE:
;       result = obj_new('NC_C_sImageFilter_TouchBorder' )
;
; METHOHDS:
...
;_____________________________IOISIOI____________________
;C:\Fanning_Libraries
;!PATH = Expand_Path('+C:\Fanning_Libraries\coyote\;+C:\Fanning_Libraries\catalyst\') + ';' + !PATH
function NC_C_sImageFilter_TouchBorder::getImageFilterType
    return, 'Single_Image_Filter_Method'
end

function NC_C_sImageFilter_TouchBorder::getImageFilterDevelopmentalState
...
function NC_C_sImageFilter_TouchBorder::apply, image = image
...
function NC_C_sImageFilter_TouchBorder::init
...
pro NC_C_sImageFilter_TouchBorder__define
  tmp = {NC_C_sImageFilter_TouchBorder, pParamStruct: ptr_new(), inherits C_sImageFilter}
end