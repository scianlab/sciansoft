...
; CALLING SEQUENCE:
;       result = obj_new('C_sImageFilter_Threshold_FullScale' )
;
; METHOHDS:
;_____________________________IOISIOI____________________

function C_sImageFilter_Threshold_FullScale::getImageFilterDevelopmentalState
    ;return, 'Release_Image_Filter_Method'
    ;return, 'Alpha_Debugging_Filter_Method'
    return, 'Beta_Release_Filter_Method'
end

function C_sImageFilter_Threshold_FullScale::getImageFilterType
    return, 'Single_Image_Filter_Method'
end

function C_sImageFilter_Threshold_FullScale::apply, image = image
    ...
    return, double(byteImage)*image
end

function C_sImageFilter_Threshold_FullScale::applySelect, image = image, select = select
...
function C_sImageFilter_Threshold_FullScale::init
    filterStruct = {Name: 'C_Threshold_FullScale',$     ;  Filter Name.
...
pro C_sImageFilter_Threshold_FullScale__define
  tmp = {C_sImageFilter_Threshold_FullScale, pParamStruct: ptr_new(), inherits C_sImageFilter}
end