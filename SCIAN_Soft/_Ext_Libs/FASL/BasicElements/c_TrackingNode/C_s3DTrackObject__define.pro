...
;
; AUTHOR:
;    Based on Dr. Steffen Härtel (2009)
;    3D integration Mods by Felipe Santibañez-Leal (2012) 
;    mail: fsantibanez@med.uchile.cl
; CALLING SEQUENCE:
;      result = obj_new('C_s3DTrackObject')
;
; METHOHDS:
;
;_____________________________IOISIOI____________________
...
function C_s3DTrackObject::getParamNameList
   return, ['Number',$
            'Extra']
end

pro C_s3DTrackObject::setParamAsStruct, paramStruct
...
function C_s3DTrackObject::getParamAsStruct
...
pro C_s3DTrackObject::set, pParamStruct = pParamStruct
   *self.pParamStruct = *pParamStruct
end

function C_s3DTrackObject::getpParamStruct
   return, self.pParamStruct
end

pro C_s3DTrackObject::setXYZValues, XYZValues
...
function C_s3DTrackObject::getpXYZValues
 return, self.pXYZValues
end


function C_s3DTrackObject::getXYZVelocity
...
function C_s3DTrackObject::getXYZDisplacement
 ...
 function C_s3DTrackObject::getSpath
   ; MOR - 18 Aug 2010
...
function C_s3DTrackObject::getMovingAverage, n = n, X = X, lines = lines
...
function C_s3DTrackObject::getRotatedEdges, sw = sw, lrr = lrr
...
function C_s3DTrackObject::getVAP
   lrr = n_elements(*(self.pTValues))
   x = self->getSpath()
   if lrr gt 1 then begin
      dt = shift(*(self.pTValues),-1)-*(self.pTValues)  
...
function C_s3DTrackObject::getVSL
...
function C_s3DTrackObject::getALH
...
function C_s3DTrackObject::getXYZAceleration
...
function C_s3DTrackObject::getBCF
...
function C_s3DTrackObject::getBCFold
...
function C_s3DTrackObject::getDPos
   dimR = n_elements(*(self.pTValues))
...
pro C_s3DTrackObject::setTValues, tValues
   *self.pTValues = tValues
end


function C_s3DTrackObject::getdTValues
...
function C_s3DTrackObject::init, number = number,$
                               extra = extra,$
                               tValues = tValues,$
                               XYZValues = XYZValues,$
...
pro C_s3DTrackObject__define
   tmp = {C_s3DTrackObject, pParamStruct:ptr_new(),$
                          pXYZValues:ptr_new(),$
                          pTValues:ptr_new(),$
                          pdTValues:ptr_new(),$
                          pXVelocity:ptr_new(),$
